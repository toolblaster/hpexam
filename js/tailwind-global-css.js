 ...
 * 3. Layout Stability (Nav Height, Page Container)
 ...
 * 9. BADGE COMPONENTS (Standardized Tags)
 * ----------------------------------------------------------------------
 */
    ...
    plugins: [
        function({ addBase, addComponents, addUtilities }) {
            ...
            addComponents({
                ...
                /* -----------------------------------------------------
                 * 4. FLIP CARD COMPONENT (FIXED FOR OVERFLOW)
                 * ----------------------------------------------------- */
                '.flip-card': {
                    perspective: '1000px',
                    cursor: 'pointer',
                    height: '12rem', /* Adjusted to 12rem: Good balance */
                },
                '.flip-card-inner': {
                    position: 'relative',
                    width: '100%',
                ...
                '.flip-card-back': {
                    ...
                    fontSize: '0.75rem', /* text-xs (12px) for readability */
                    lineHeight: '1.4', /* Tighter line height for dense text */
                },
                /* Ensure paragraphs inside card back inherit smaller text */
                '.flip-card-back p': {
                    fontSize: 'inherit',
                    lineHeight: 'inherit',
                },
                /* Hide scrollbar on flip card back for cleaner look (optional, but good for cards) */
